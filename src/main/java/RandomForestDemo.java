...
public class RandomForestDemo {
     ...
     */
    public static final String TRAINING_DATA_SET_FILENAME = "decision-random-train.arff";
    public static final String TESTING_DATA_SET_FILENAME = "decision-random-test.arff";
